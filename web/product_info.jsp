			...
			<tr>
				...
				<td><div style="text-align:right; margin:5px 10px 5px 0px">
						<a href="index.jsp">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;<a
							href="product_list.jsp">&nbsp;计算机</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;&nbsp;${product.name}
					</div>
									...
									<tr>
										<td width="30%">
											...
											<div class="divbookcover">
												<p>
													<img src="${pageContext.request.contextPath}${product.getImgurl()}"
										...
										<td style="padding:20px 5px 5px 5px"><img
											src="${product.getImgurl()}" width="16" height="13" /><font
											class="bookname">&nbsp;&nbsp;${product.name}</font>

											<hr />售价：<font color="#FF0000">${product.price}</font>
											<hr /> 类别：${requestScope.product.getCategory()}

											<hr />
											<p>
												<b>内容简介：</b>
											</p> ${requestScope.product.getDescription()}</td>
									</tr>
								</table></td>
						</tr>
					</table>
